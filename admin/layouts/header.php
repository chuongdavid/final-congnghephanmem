    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Xin chào ADMIN <sup>2</sup></div>
            </a>
            ...
            <li class="nav-item <?php echo isset($open) && $open == "category" ? 'active' : '' ?>">
                <a class="nav-link" href="<?php echo modulesAdmin("category")?>">
            ...
            <li class="nav-item <?php echo isset($open) && $open == "sales" ? 'active' : '' ?>">
                <a class="nav-link" href="<?php echo modulesAdmin("sales")?>">
                    <i class="fa fa-tag"></i>
