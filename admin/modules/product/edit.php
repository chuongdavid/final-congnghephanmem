        ...
        if($_SERVER["REQUEST_METHOD"]=="POST"){
            ...
            elseif (postInput("location")=='') {
                ...
                if(empty($error)){ //if no error do this
                    ...
                    $update_product = $db -> update('product',$data,array('id'=>$id));
                        ...
                        <div class="col-md-10">
                            <form method="POST" action="" enctype="multipart/form-data" >
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputNameProduct" value="<?php echo $EditProduct['name'] ?>" placeholder="Vui lòng nhập tên sản phẩm" name="name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="number" class="form-control" value="<?php echo $EditProduct['price'] ?>" id="inputPriceProduct" placeholder="Vui lòng nhập giá sản phẩm(e.g: 9.000.000)" name="price">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-3">
                                    <input type="number" class="form-control" value="<?php echo $EditProduct['sale'] ?>" id="inputSale" placeholder="e.g: 10%" name="sale" value ="0">
                                    ...
                                    <?php endif ?>
                                    <img src="<?php echo base_url() ?>public/uploads/product/<?php echo $EditProduct['image'] ?>" width="100px" height="100px" alt="">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="inputContent" class="col-sm-8 col-form-label">Thông tin sản phẩm</label>
                                    <div class="col-sm-10">
                                    <textarea type="text" rows=10  class="form-control" id="inputContent" placeholder="Vui lòng nhập thông tin sản phẩm" name="content"><?php echo $EditProduct['content'] ?></textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="number" class="form-control" value="<?php echo $EditProduct['quantity'] ?>" id="inputContent" placeholder="Vui lòng nhập số lượng sản phẩm" name="quantity">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                    <textarea type="text" rows=10 class="form-control"  id="inputContent" placeholder="Vui lòng nhập thông tin điều kiện sử dụng" name="how_to_use"><?php echo $EditProduct['how_to_use'] ?></textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                    <textarea type="text" rows=10 class="form-control"  id="inputContent" placeholder="Vui lòng nhập điểm nổi bật của sản phẩm" name="remarkable_thing"><?php echo $EditProduct['remarkable_thing'] ?></textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                    <textarea type="text" rows=10 class="form-control" id="inputContent" placeholder="Vui lòng nhập địa điểm" name="location"><?php echo $EditProduct['location'] ?></textarea>
