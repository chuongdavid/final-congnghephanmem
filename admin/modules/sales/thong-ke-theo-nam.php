...
<?php 
        ...
        require_once __DIR__. "/../../../autoload/autoload.php";
            ...
            if(isset($_POST['year'])){
                ...
                $sum_total = 0;
                $all_sale = [];
                $sql = "SELECT orders.*,product.name,transaction.amount FROM `orders`,`product`,`transaction` WHERE (orders.product_id = product.id) AND (transaction.id = orders.transaction_id) AND (orders.created_at BETWEEN '".$year."-01-01'  AND '".$year."-12-31')" ;
